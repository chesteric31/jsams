...
/**
 * Abstract class for all multiples selection into table of wizard.
 * 
 * @author chesteric31
 * @version $Revision$ $Date::                  $ $Author$
 */
public abstract class AbstractWizardMultipleSelectionTableML implements MouseListener {
     ...
     */
    public AbstractWizardMultipleSelectionTableML(TransferBean bean) {
        this.bean = bean;
    }
