package be.jsams.client.wizard.frame;
...
import be.jsams.client.wizard.CancelAction;
import be.jsams.client.wizard.DefaultJWizardComponents;
import be.jsams.client.wizard.FinishAction;
import be.jsams.client.wizard.common.SimpleButtonPanel;
...
//                  BorderLayout.CENTER);
    logoPanel.add(new JLabel(logo), BorderLayout.CENTER);
