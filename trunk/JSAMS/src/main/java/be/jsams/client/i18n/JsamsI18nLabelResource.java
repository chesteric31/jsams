...
/**
 * Resource file that contains all {@link I18nString} properties key for label
 * purpose.
 * 
 * @author chesteric31
...
public class JsamsI18nLabelResource {
	...
	public static final I18nString LABEL_OPEN_SOCIETY = new I18nString(
			"label.open.society");

	public static final I18nString LABEL_OPEN_SOCIETY_AVAILABLES = new I18nString(
			"label.open.society_availables");
