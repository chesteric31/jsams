...
public class JsamsI18nResource {
	...
	public static final I18nString MENU_ITEM_SOCIETY_PARAMETERS = new I18nString(
			"menu.item.society_parameters");

	public static final I18nString MENU_ITEM_PRINTER_PARAMETERS = new I18nString(
			"menu.item.printer_parameters");
	...
	public static final I18nString MENU_ITEM_COPY = new I18nString(
			"menu.item.copy");
	...
	public static final I18nString MENU_ITEM_ABOUT = new I18nString(
			"menu.item.about");

	public static final I18nString MENU_ITEM_ESTIMATE = new I18nString(
			"menu.item.estimate");

	public static final I18nString MENU_ITEM_COMMAND = new I18nString(
			"menu.item.command");

	public static final I18nString MENU_ITEM_DELIVERY_ORDER = new I18nString(
			"menu.item.delivery_order");

	public static final I18nString MENU_ITEM_BILL = new I18nString(
			"menu.item.bill");

	public static final I18nString MENU_ITEM_CREDIT_NOTE = new I18nString(
			"menu.item.credit_note");
