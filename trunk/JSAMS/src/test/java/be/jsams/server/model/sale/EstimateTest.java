 ...
 */
public class EstimateTest extends AbstractModelTest {
    ...
    public void testEstimateEstimateBean() {
        ...
        checkAgent(bean.getAgent(), estimate.getAgent());
        checkAddress(bean.getBillingAddress(), estimate.getBillingAddress());
        assertEquals(bean.getCreationDate(), estimate.getCreationDate());
        checkCustomer(bean.getCustomer(), estimate.getCustomer());
