...
public class SearchProductCategoryPanel extends
        SearchPanel<ProductCategoryBean, ProductCategoryTableMouseListener, ProductCategoryService> {
    ...
    public void performOk() {
        ...
        List<ProductCategoryBean> categories = ((ProductCategoryService) super.getService()).findByCriteria(criteria);
