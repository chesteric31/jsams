...
public class AddressBeanView extends AbstractView<AddressBean, JPanel, JPanel> {
    ...
    public JPanel createEditView() {
        ...
        JTextField textFieldBox = helper.createBindingTextComponent(bean, AddressBean.BOX_PROPERTY, false, false);
        JTextField textFieldStreet = helper.createBindingTextComponent(bean, AddressBean.STREET_PROPERTY, true, false);
        JTextField textFieldNumber = helper.createBindingTextComponent(bean, AddressBean.NUMBER_PROPERTY, true, false);
        JTextField textFieldZipCode = helper
                .createBindingTextComponent(bean, AddressBean.ZIPCODE_PROPERTY, true, false);
        JTextField textFieldCity = helper.createBindingTextComponent(bean, AddressBean.CITY_PROPERTY, true, false);
        JTextField textFieldCountry = helper
                .createBindingTextComponent(bean, AddressBean.COUNTRY_PROPERTY, true, false);
