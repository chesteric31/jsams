 ...
 */
public class EditCustomerDialog extends AbstractEditDialog<CustomerBean, CustomerValidator, CustomerService> {
    ...
    private static final Log LOGGER = LogFactory.getLog(EditCustomerDialog.class);
