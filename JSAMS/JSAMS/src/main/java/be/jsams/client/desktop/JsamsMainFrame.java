...
public class JsamsMainFrame extends JsamsFrame {
    ...
    private void buildFileMenu() {
        ...
        newMI.setAction(new EditSocietyAction(newMI.getText(), newMI.getIcon(), new SocietyBean()));
    ...
    /**
     * @param managementMenu the managementMenu to set
     */
    ...
    /**
     * @param salesMenu the salesMenu to set
     */
