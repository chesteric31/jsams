 ...
 */
public class EditBillValidatorTest extends AbstractEditValidatorTest {
    ...
    public void testValidateBlankPaymentMode() {
        ...
        String formattedText = retrieveFormattedText(result);
        assertTrue(formattedText.contains(JsamsI18nResource.ERROR_IS_MANDATORY.getTranslation()));
        assertTrue(formattedText.contains(JsamsI18nLabelResource.LABEL_PAYMENT_MODE.getTranslation()));
    }
    ...
    public void testValidateBlankDueDate() {
        ...
        String formattedText = retrieveFormattedText(result);
        assertTrue(formattedText.contains(JsamsI18nResource.ERROR_IS_MANDATORY.getTranslation()));
        assertTrue(formattedText.contains(JsamsI18nLabelResource.LABEL_DUE_DATE.getTranslation()));
    }
    ...
    public void testValidateBlankDateFirstRemember() {
        ...
        String formattedText = retrieveFormattedText(result);
        assertTrue(formattedText.contains(JsamsI18nResource.ERROR_IS_MANDATORY.getTranslation()));
        assertTrue(formattedText.contains(JsamsI18nLabelResource.LABEL_FIRST_REMEMBER_DATE.getTranslation()));
    }
    ...
    public void testValidateBlankDateSecondRemember() {
        ...
        String formattedText = retrieveFormattedText(result);
        assertTrue(formattedText.contains(JsamsI18nResource.ERROR_IS_MANDATORY.getTranslation()));
        assertTrue(formattedText.contains(JsamsI18nLabelResource.LABEL_SECOND_REMEMBER_DATE.getTranslation()));
    }
    ...
    public void testValidateBlankDateFormalNotice() {
        ...
        String formattedText = retrieveFormattedText(result);
        assertTrue(formattedText.contains(JsamsI18nResource.ERROR_IS_MANDATORY.getTranslation()));
        assertTrue(formattedText.contains(JsamsI18nLabelResource.LABEL_FORMAL_NOTICE_DATE.getTranslation()));
    }
