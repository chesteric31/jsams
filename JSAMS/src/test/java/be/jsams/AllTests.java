...
@SuiteClasses(value = { DoubleFormatterTest.class, UserContextTest.class, EditAddressValidatorTest.class,
        ...
        SearchProductValidatorTest.class, TransferModeValidatorTest.class, AddressBeanTest.class,
        ...
        CreditNoteDetailBeanTest.class, TransferBeanTest.class, EmailValidatorTest.class, StringValidatorTest.class,
