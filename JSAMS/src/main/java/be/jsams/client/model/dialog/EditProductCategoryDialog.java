...
public class EditProductCategoryDialog extends
        EditDialog<ProductCategory, ProductCategoryValidator, ProductCategoryService> {
     ...
     * @param model
     *            the {@link ProductCategory} model
     */
    public EditProductCategoryDialog(final I18nString title, ProductCategory model) {
        super(null, title);
