...
public class JsamsCloseableTabbedPane extends JTabbedPane {
	...
	public void addTab(I18nString title, final String iconFileName,
		...
		if (iconFileName != null) {
			tabIcon = new ImageIcon(IconUtil
					.buildIcon(IconUtil.MENU_ICON_PREFIX + iconFileName));
			tabTitle = new JsamsLabel(title, tabIcon);
		} else {
			tabTitle = new JsamsLabel(title);
		}

		JsamsButton tabCloseButton = new JsamsButton(IconUtil.MENU_ICON_PREFIX
