...
// Generated on: 2011.12.21 at 05:34:43 PM CET 
//
...
@XmlType(name = "", propOrder = { "society", "customer", "creationDate", "dueDate", "address", "number", "details",
        "totalEt", "vat", "totalAti" })
...
public class BillXml {
    ...
    @XmlElement(name = "due_date", required = true, type = String.class)
    @XmlJavaTypeAdapter(Adapter1.class)
    @XmlSchemaType(name = "date")
