...
import be.jsams.server.model.xml.bill.ObjectFactory;
 ...
 */
public class XmlBillGeneratorImpl implements XmlGenerator<BillBean, BillXml> {

    /**
     * {@inheritDoc}
     */
    @Override
    public BillXml generateXml(BillBean object) {
        ObjectFactory factory = new ObjectFactory();
        BillXml xml = factory.createBill();
        xml.setCreationDate(object.getCreationDate());
        xml.setDueDate(object.getDueDate());
        ...
        List<BillDetailBean> details = object.getDetails();
        ...
        for (BillDetailBean bean : details) {
